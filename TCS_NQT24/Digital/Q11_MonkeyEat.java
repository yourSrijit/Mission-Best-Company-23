...
int main()
{
    ...
    if(n<0 || m<0 ||p<0 ||k<0 ||j<0){
        ...
        cout<<"Number of Monkeys left on the Tree:"<<(n-ateP-ateB);
...
Monkey can either eat k Bananas or j Peanuts. If for last Monkey there are less than k Bananas left on the ground or less than j Peanuts left on
the ground, only that Monkey can eat Bananas(<k) along with the Peanuts(<j).
...
20 2 3 12 12 Number of Monkeys left on the tree:10
...
For any wrong input display INVALID INPU
 */